...
module HC_64_BK6_KS0_top (a,b,cin,sum,cout,clk,rst);
input [63:0]a;
input [63:0]b;
input cin;
output reg [63:0]sum;
...
wire cout_w;
reg cin_r;
HC_64_BK6_KS0 u0 (a,b,cin_r,sum_w,cout_w);
...
wire [63:0] pp_level6;
            ...
            endgenerate 
             generate
              for (i = 32-1 ;i<64;i=i+32) begin:gen_ks_2_5
            ...
            endgenerate 
             generate
              for (i = 64-1 ;i<64;i=i+64) begin:gen_ks_2_6
