...
module Hybrid_64_BK2_KL4_Fanout2_top (a,b,cin,sum,cout,clk,rst);
input [63:0]a;
input [63:0]b;
input cin;
output reg [63:0]sum;
...
wire cout_w;
reg cin_r;
Hybrid_64_BK2_KL4_Fanout2 u0 (a,b,cin_r,sum_w,cout_w);
...
module Hybrid_64_BK2_KL4_Fanout2 (a,b,cin,sum,cout);
...
wire [63:0] pp_level6;
            ...
            endgenerate
             generate
              for (i = 4-1 ;i<64;i=i+4) begin:gen_hybrid_block22
               ...
               AND2_X1 and5 (pp_level1[i],pp_level1[i-2],pp_level2[i]);        
              end
          ...
          // pre process continue last 1
           generate
            for (i = 4;i<4*2 ;i=i+4) begin:gen_kl_block313
             ...
             // assign  pp_level3[3+i]=pp_level2[3+i]&pp_level2[i+3-4];
               AND2_X1 and6 (pp_level2[3+i],pp_level2[i+3-4],pp_level3[3+i]);
            end
           endgenerate
          
          // pre process continue last 1
           generate
            for (i = 4;i<4*2 ;i=i+4) begin:gen_kl_block3111
              //assign  gnpg_level3[11+i]=gnpg_level2[11+i]|pp_level2[11+i]&gnpg_level2[i+11-4]; 
              AO21 a6 (pp_level2[11+i],gnpg_level2[i+11-4],gnpg_level2[11+i],gnpg_level3[11+i]);
             // assign  pp_level3[11+i]=pp_level2[11+i]&pp_level2[i+11-4];
               AND2_X1 and6 (pp_level2[11+i],pp_level2[i+11-4],pp_level3[11+i]);
            end
           endgenerate
          
          // pre process continue last 1
           generate
            for (i = 4;i<4*2 ;i=i+4) begin:gen_kl_block3119
             ...
             // assign  pp_level3[19+i]=pp_level2[19+i]&pp_level2[i+19-4];
               AND2_X1 and6 (pp_level2[19+i],pp_level2[i+19-4],pp_level3[19+i]);
            end
           endgenerate
          
          // pre process continue last 1
           generate
            for (i = 4;i<4*2 ;i=i+4) begin:gen_kl_block3127
              //assign  gnpg_level3[27+i]=gnpg_level2[27+i]|pp_level2[27+i]&gnpg_level2[i+27-4]; 
              AO21 a6 (pp_level2[27+i],gnpg_level2[i+27-4],gnpg_level2[27+i],gnpg_level3[27+i]);
             // assign  pp_level3[27+i]=pp_level2[27+i]&pp_level2[i+27-4];
               AND2_X1 and6 (pp_level2[27+i],pp_level2[i+27-4],pp_level3[27+i]);
            end
           endgenerate
          
          // pre process continue last 1
           generate
            for (i = 4;i<4*2 ;i=i+4) begin:gen_kl_block3135
             ...
             // assign  pp_level3[35+i]=pp_level2[35+i]&pp_level2[i+35-4];
               AND2_X1 and6 (pp_level2[35+i],pp_level2[i+35-4],pp_level3[35+i]);
            end
           endgenerate
          
          // pre process continue last 1
           generate
            for (i = 4;i<4*2 ;i=i+4) begin:gen_kl_block3143
              //assign  gnpg_level3[43+i]=gnpg_level2[43+i]|pp_level2[43+i]&gnpg_level2[i+43-4]; 
              AO21 a6 (pp_level2[43+i],gnpg_level2[i+43-4],gnpg_level2[43+i],gnpg_level3[43+i]);
             // assign  pp_level3[43+i]=pp_level2[43+i]&pp_level2[i+43-4];
               AND2_X1 and6 (pp_level2[43+i],pp_level2[i+43-4],pp_level3[43+i]);
            end
           endgenerate
          
          // pre process continue last 1
           generate
            for (i = 4;i<4*2 ;i=i+4) begin:gen_kl_block3151
             ...
             // assign  pp_level3[51+i]=pp_level2[51+i]&pp_level2[i+51-4];
               AND2_X1 and6 (pp_level2[51+i],pp_level2[i+51-4],pp_level3[51+i]);
            end
           endgenerate
          
          // pre process continue last 1
           generate
            for (i = 4;i<4*2 ;i=i+4) begin:gen_kl_block3159
              //assign  gnpg_level3[59+i]=gnpg_level2[59+i]|pp_level2[59+i]&gnpg_level2[i+59-4]; 
              AO21 a6 (pp_level2[59+i],gnpg_level2[i+59-4],gnpg_level2[59+i],gnpg_level3[59+i]);
             // assign  pp_level3[59+i]=pp_level2[59+i]&pp_level2[i+59-4];
               AND2_X1 and6 (pp_level2[59+i],pp_level2[i+59-4],pp_level3[59+i]);
            end
           endgenerate
         ...
         generate
           for (i = 11;i<4*2+11 ;i=i+4) begin:gen_mul_kl_block2211
              // assign  gnpg_level4[i]=gnpg_level3[i]|pp_level3[i]&gnpg_level3[11+4*2-4-4*2];
              AO21 a7 (pp_level3[i],gnpg_level3[11+4*2-4-4*2],gnpg_level3[i],gnpg_level4[i]);
              // assign  pp_level4[i]=pp_level3[i]&pp_level3[11+4*2-4-4*2];
               AND2_X1 and7 (pp_level3[i],pp_level3[11+4*2-4-4*2],pp_level4[i]);
           end 
         endgenerate
         
         // Multiple fanout stage
         generate
           for (i = 19;i<4*2+19 ;i=i+4) begin:gen_mul_kl_block2219
              // assign  gnpg_level4[i]=gnpg_level3[i]|pp_level3[i]&gnpg_level3[19+4*2-4-4*2];
              AO21 a7 (pp_level3[i],gnpg_level3[19+4*2-4-4*2],gnpg_level3[i],gnpg_level4[i]);
              // assign  pp_level4[i]=pp_level3[i]&pp_level3[19+4*2-4-4*2];
               AND2_X1 and7 (pp_level3[i],pp_level3[19+4*2-4-4*2],pp_level4[i]);
           end 
         endgenerate
         
         // Multiple fanout stage
         generate
           for (i = 27;i<4*2+27 ;i=i+4) begin:gen_mul_kl_block2227
              // assign  gnpg_level4[i]=gnpg_level3[i]|pp_level3[i]&gnpg_level3[27+4*2-4-4*2];
              AO21 a7 (pp_level3[i],gnpg_level3[27+4*2-4-4*2],gnpg_level3[i],gnpg_level4[i]);
              // assign  pp_level4[i]=pp_level3[i]&pp_level3[27+4*2-4-4*2];
               AND2_X1 and7 (pp_level3[i],pp_level3[27+4*2-4-4*2],pp_level4[i]);
           end 
         endgenerate
         
         // Multiple fanout stage
         generate
           for (i = 35;i<4*2+35 ;i=i+4) begin:gen_mul_kl_block2235
              // assign  gnpg_level4[i]=gnpg_level3[i]|pp_level3[i]&gnpg_level3[35+4*2-4-4*2];
              AO21 a7 (pp_level3[i],gnpg_level3[35+4*2-4-4*2],gnpg_level3[i],gnpg_level4[i]);
              // assign  pp_level4[i]=pp_level3[i]&pp_level3[35+4*2-4-4*2];
               AND2_X1 and7 (pp_level3[i],pp_level3[35+4*2-4-4*2],pp_level4[i]);
           end 
         endgenerate
         
         // Multiple fanout stage
         generate
           for (i = 43;i<4*2+43 ;i=i+4) begin:gen_mul_kl_block2243
              // assign  gnpg_level4[i]=gnpg_level3[i]|pp_level3[i]&gnpg_level3[43+4*2-4-4*2];
              AO21 a7 (pp_level3[i],gnpg_level3[43+4*2-4-4*2],gnpg_level3[i],gnpg_level4[i]);
              // assign  pp_level4[i]=pp_level3[i]&pp_level3[43+4*2-4-4*2];
               AND2_X1 and7 (pp_level3[i],pp_level3[43+4*2-4-4*2],pp_level4[i]);
           end 
         endgenerate
         
         // Multiple fanout stage
         generate
           for (i = 51;i<4*2+51 ;i=i+4) begin:gen_mul_kl_block2251
              // assign  gnpg_level4[i]=gnpg_level3[i]|pp_level3[i]&gnpg_level3[51+4*2-4-4*2];
              AO21 a7 (pp_level3[i],gnpg_level3[51+4*2-4-4*2],gnpg_level3[i],gnpg_level4[i]);
              // assign  pp_level4[i]=pp_level3[i]&pp_level3[51+4*2-4-4*2];
               AND2_X1 and7 (pp_level3[i],pp_level3[51+4*2-4-4*2],pp_level4[i]);
           end 
         endgenerate
         
         // Multiple fanout stage
         generate
           for (i = 59;i<4*2+59 ;i=i+4) begin:gen_mul_kl_block2259
              // assign  gnpg_level4[i]=gnpg_level3[i]|pp_level3[i]&gnpg_level3[59+4*2-4-4*2];
              AO21 a7 (pp_level3[i],gnpg_level3[59+4*2-4-4*2],gnpg_level3[i],gnpg_level4[i]);
              // assign  pp_level4[i]=pp_level3[i]&pp_level3[59+4*2-4-4*2];
               AND2_X1 and7 (pp_level3[i],pp_level3[59+4*2-4-4*2],pp_level4[i]);
           end 
         endgenerate
         ...
         // Multiple fanout stage
         generate
           for (i = 19;i<4*2+19 ;i=i+4) begin:gen_mul_kl_block2319
              // assign  gnpg_level5[i]=gnpg_level4[i]|pp_level4[i]&gnpg_level4[19+4*2-4-4*4];
              AO21 a7 (pp_level4[i],gnpg_level4[19+4*2-4-4*4],gnpg_level4[i],gnpg_level5[i]);
              // assign  pp_level5[i]=pp_level4[i]&pp_level4[19+4*2-4-4*4];
               AND2_X1 and7 (pp_level4[i],pp_level4[19+4*2-4-4*4],pp_level5[i]);
           end 
         endgenerate
         
         // Multiple fanout stage
         generate
           for (i = 27;i<4*2+27 ;i=i+4) begin:gen_mul_kl_block2327
              // assign  gnpg_level5[i]=gnpg_level4[i]|pp_level4[i]&gnpg_level4[27+4*2-4-4*4];
              AO21 a7 (pp_level4[i],gnpg_level4[27+4*2-4-4*4],gnpg_level4[i],gnpg_level5[i]);
              // assign  pp_level5[i]=pp_level4[i]&pp_level4[27+4*2-4-4*4];
               AND2_X1 and7 (pp_level4[i],pp_level4[27+4*2-4-4*4],pp_level5[i]);
           end 
         endgenerate
         
         // Multiple fanout stage
         generate
           for (i = 35;i<4*2+35 ;i=i+4) begin:gen_mul_kl_block2335
              // assign  gnpg_level5[i]=gnpg_level4[i]|pp_level4[i]&gnpg_level4[35+4*2-4-4*4];
              AO21 a7 (pp_level4[i],gnpg_level4[35+4*2-4-4*4],gnpg_level4[i],gnpg_level5[i]);
              // assign  pp_level5[i]=pp_level4[i]&pp_level4[35+4*2-4-4*4];
               AND2_X1 and7 (pp_level4[i],pp_level4[35+4*2-4-4*4],pp_level5[i]);
           end 
         endgenerate
         
         // Multiple fanout stage
         generate
           for (i = 43;i<4*2+43 ;i=i+4) begin:gen_mul_kl_block2343
              // assign  gnpg_level5[i]=gnpg_level4[i]|pp_level4[i]&gnpg_level4[43+4*2-4-4*4];
              AO21 a7 (pp_level4[i],gnpg_level4[43+4*2-4-4*4],gnpg_level4[i],gnpg_level5[i]);
              // assign  pp_level5[i]=pp_level4[i]&pp_level4[43+4*2-4-4*4];
               AND2_X1 and7 (pp_level4[i],pp_level4[43+4*2-4-4*4],pp_level5[i]);
           end 
         endgenerate
         
         // Multiple fanout stage
         generate
           for (i = 51;i<4*2+51 ;i=i+4) begin:gen_mul_kl_block2351
              // assign  gnpg_level5[i]=gnpg_level4[i]|pp_level4[i]&gnpg_level4[51+4*2-4-4*4];
              AO21 a7 (pp_level4[i],gnpg_level4[51+4*2-4-4*4],gnpg_level4[i],gnpg_level5[i]);
              // assign  pp_level5[i]=pp_level4[i]&pp_level4[51+4*2-4-4*4];
               AND2_X1 and7 (pp_level4[i],pp_level4[51+4*2-4-4*4],pp_level5[i]);
           end 
         endgenerate
         
         // Multiple fanout stage
         generate
           for (i = 59;i<4*2+59 ;i=i+4) begin:gen_mul_kl_block2359
              // assign  gnpg_level5[i]=gnpg_level4[i]|pp_level4[i]&gnpg_level4[59+4*2-4-4*4];
              AO21 a7 (pp_level4[i],gnpg_level4[59+4*2-4-4*4],gnpg_level4[i],gnpg_level5[i]);
              // assign  pp_level5[i]=pp_level4[i]&pp_level4[59+4*2-4-4*4];
               AND2_X1 and7 (pp_level4[i],pp_level4[59+4*2-4-4*4],pp_level5[i]);
           end 
         endgenerate
         ...
         // Multiple fanout stage
         generate
           for (i = 35;i<4*2+35 ;i=i+4) begin:gen_mul_kl_block2435
              // assign  gnpg_level6[i]=gnpg_level5[i]|pp_level5[i]&gnpg_level5[35+4*2-4-4*8];
              AO21 a7 (pp_level5[i],gnpg_level5[35+4*2-4-4*8],gnpg_level5[i],gnpg_level6[i]);
              // assign  pp_level6[i]=pp_level5[i]&pp_level5[35+4*2-4-4*8];
               AND2_X1 and7 (pp_level5[i],pp_level5[35+4*2-4-4*8],pp_level6[i]);
           end 
         endgenerate
         
         // Multiple fanout stage
         generate
           for (i = 43;i<4*2+43 ;i=i+4) begin:gen_mul_kl_block2443
              // assign  gnpg_level6[i]=gnpg_level5[i]|pp_level5[i]&gnpg_level5[43+4*2-4-4*8];
              AO21 a7 (pp_level5[i],gnpg_level5[43+4*2-4-4*8],gnpg_level5[i],gnpg_level6[i]);
              // assign  pp_level6[i]=pp_level5[i]&pp_level5[43+4*2-4-4*8];
               AND2_X1 and7 (pp_level5[i],pp_level5[43+4*2-4-4*8],pp_level6[i]);
           end 
         endgenerate
         
         // Multiple fanout stage
         generate
           for (i = 51;i<4*2+51 ;i=i+4) begin:gen_mul_kl_block2451
              // assign  gnpg_level6[i]=gnpg_level5[i]|pp_level5[i]&gnpg_level5[51+4*2-4-4*8];
              AO21 a7 (pp_level5[i],gnpg_level5[51+4*2-4-4*8],gnpg_level5[i],gnpg_level6[i]);
              // assign  pp_level6[i]=pp_level5[i]&pp_level5[51+4*2-4-4*8];
               AND2_X1 and7 (pp_level5[i],pp_level5[51+4*2-4-4*8],pp_level6[i]);
           end 
         endgenerate
         
         // Multiple fanout stage
         generate
           for (i = 59;i<4*2+59 ;i=i+4) begin:gen_mul_kl_block2459
              // assign  gnpg_level6[i]=gnpg_level5[i]|pp_level5[i]&gnpg_level5[59+4*2-4-4*8];
              AO21 a7 (pp_level5[i],gnpg_level5[59+4*2-4-4*8],gnpg_level5[i],gnpg_level6[i]);
              // assign  pp_level6[i]=pp_level5[i]&pp_level5[59+4*2-4-4*8];
               AND2_X1 and7 (pp_level5[i],pp_level5[59+4*2-4-4*8],pp_level6[i]);
           end 
         endgenerate
