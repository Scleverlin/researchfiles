...
module HC_64_BK3_KS3_top (a,b,cin,sum,cout,clk,rst);
input [63:0]a;
input [63:0]b;
input cin;
output reg [63:0]sum;
...
wire cout_w;
reg cin_r;
HC_64_BK3_KS3 u0 (a,b,cin_r,sum_w,cout_w);
...
wire [63:0] pp_level6;
            ...
            //KS 
            generate
              for (i = 0;i<(64-15) ;i=i+8) begin:gen_ks_4_1
               // assign gnpg_level4[15+i]=gnpg_level3[15+i]|pp_level3[15+i]&gnpg_level3[15+i-1*8];
               AO21 a5 (pp_level3[15+i],gnpg_level3[15+i-1*8],gnpg_level3[15+i],gnpg_level4[15+i]);
              //  assign pp_level4[15+i]=pp_level3[15+i]&pp_level3[15+i-1*8];
               AND2_X1 and5 (pp_level3[15+i],pp_level3[15+i-1*8],pp_level4[15+i]);
               end
            endgenerate
            generate
        ...
        generate
            ...
            //KS 
            generate
              for (i = 0;i<(64-23) ;i=i+8) begin:gen_ks_4_2
               // assign gnpg_level5[23+i]=gnpg_level4[23+i]|pp_level4[23+i]&gnpg_level4[23+i-2*8];
               AO21 a5 (pp_level4[23+i],gnpg_level4[23+i-2*8],gnpg_level4[23+i],gnpg_level5[23+i]);
              //  assign pp_level5[23+i]=pp_level4[23+i]&pp_level4[23+i-2*8];
               AND2_X1 and5 (pp_level4[23+i],pp_level4[23+i-2*8],pp_level5[23+i]);
               end
            endgenerate
            generate
        ...
        generate
            ...
            //KS 
            generate
              for (i = 0;i<(64-39) ;i=i+8) begin:gen_ks_4_3
               // assign gnpg_level6[39+i]=gnpg_level5[39+i]|pp_level5[39+i]&gnpg_level5[39+i-4*8];
               AO21 a5 (pp_level5[39+i],gnpg_level5[39+i-4*8],gnpg_level5[39+i],gnpg_level6[39+i]);
              //  assign pp_level6[39+i]=pp_level5[39+i]&pp_level5[39+i-4*8];
               AND2_X1 and5 (pp_level5[39+i],pp_level5[39+i-4*8],pp_level6[39+i]);
               end
            endgenerate
            generate
