...
wire [63:0] pp_level6;
            ...
            endgenerate 
             generate
              for (i = 64-1 ;i<64;i=i+64) begin:gen_block_sa26
                //assign gnpg_level6[i]=gnpg_level5[i]|pp_level5[i]&gnpg_level5[i-32];  
                  AO21 a4 (pp_level5[i],gnpg_level5[i-32],gnpg_level5[i],gnpg_level6[i]);
               // assign pp_level6[i]=pp_level5[i]&pp_level5[i-32];           
               AND2_X1 and4 (pp_level5[i],pp_level5[i-32],pp_level6[i]);
              end
            endgenerate generate
