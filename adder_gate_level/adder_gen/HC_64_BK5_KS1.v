...
wire cout_w;
reg cin_r;
HC_64_BK5_KS1 u0 (a,b,cin_r,sum_w,cout_w);
...
wire [63:0] pp_level6;
            ...
            //KS 
            generate
              for (i = 0;i<(64-63) ;i=i+32) begin:gen_ks_4_1
               // assign gnpg_level6[63+i]=gnpg_level5[63+i]|pp_level5[63+i]&gnpg_level5[63+i-1*32];
               AO21 a5 (pp_level5[63+i],gnpg_level5[63+i-1*32],gnpg_level5[63+i],gnpg_level6[63+i]);
              //  assign pp_level6[63+i]=pp_level5[63+i]&pp_level5[63+i-1*32];
               AND2_X1 and5 (pp_level5[63+i],pp_level5[63+i-1*32],pp_level6[63+i]);
               end
            endgenerate
            generate
