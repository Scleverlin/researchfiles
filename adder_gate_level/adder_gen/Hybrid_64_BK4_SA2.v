...
module Hybrid_64_BK4_SA2_top (a,b,cin,sum,cout,clk,rst);
input [63:0]a;
input [63:0]b;
input cin;
output reg [63:0]sum;
...
wire cout_w;
reg cin_r;
Hybrid_64_BK4_SA2 u0 (a,b,cin_r,sum_w,cout_w);
...
wire [63:0] pp_level6;
            ...
            endgenerate 
        generate
             for (i = 31;i<64 ;i=i+32) begin:gen_block_sa310
            // assign gnpg_level5[i+0]=gnpg_level4[i+0]|pp_level4[i+0]&gnpg_level4[i-16];  
            AO21 a5 (pp_level4[i+0],gnpg_level4[i-16],gnpg_level4[i+0],gnpg_level5[i+0]);
           //  assign pp_level5[i+0]=pp_level4[i+0]&pp_level4[i-16];     
              AND2_X1 and5 (pp_level4[i+0],pp_level4[i-16],pp_level5[i+0]);       
         end
       endgenerate
       //old_value_pass
       generate
       ...
       endgenerate 
        generate
             for (i = 47;i<64 ;i=i+64) begin:gen_block_sa320
            // assign gnpg_level6[i+0]=gnpg_level5[i+0]|pp_level5[i+0]&gnpg_level5[i-16];  
            AO21 a5 (pp_level5[i+0],gnpg_level5[i-16],gnpg_level5[i+0],gnpg_level6[i+0]);
           //  assign pp_level6[i+0]=pp_level5[i+0]&pp_level5[i-16];     
              AND2_X1 and5 (pp_level5[i+0],pp_level5[i-16],pp_level6[i+0]);       
         end
       endgenerate
       //old_value_pass
       generate
       ...
       endgenerate
        ...
        generate
             for (i = 47;i<64 ;i=i+64) begin:gen_block_sa3216
            // assign gnpg_level6[i+16]=gnpg_level5[i+16]|pp_level5[i+16]&gnpg_level5[i-16];  
            AO21 a5 (pp_level5[i+16],gnpg_level5[i-16],gnpg_level5[i+16],gnpg_level6[i+16]);
           //  assign pp_level6[i+16]=pp_level5[i+16]&pp_level5[i-16];     
              AND2_X1 and5 (pp_level5[i+16],pp_level5[i-16],pp_level6[i+16]);       
         end
       endgenerate
       //old_value_pass
       generate
