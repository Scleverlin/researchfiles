...
module Hybrid_64_BK3_SA3_top (a,b,cin,sum,cout,clk,rst);
input [63:0]a;
input [63:0]b;
input cin;
output reg [63:0]sum;
...
wire cout_w;
reg cin_r;
Hybrid_64_BK3_SA3 u0 (a,b,cin_r,sum_w,cout_w);
...
wire [63:0] pp_level6;
            ...
            endgenerate 
             generate
              for (i = 8-1 ;i<64;i=i+8) begin:gen_block_sa23
               ...
               AND2_X1 and4 (pp_level2[i],pp_level2[i-4],pp_level3[i]);
              end
            endgenerate generate
            ...
            endgenerate 
        generate
             for (i = 15;i<64 ;i=i+16) begin:gen_block_sa310
            // assign gnpg_level4[i+0]=gnpg_level3[i+0]|pp_level3[i+0]&gnpg_level3[i-8];  
            AO21 a5 (pp_level3[i+0],gnpg_level3[i-8],gnpg_level3[i+0],gnpg_level4[i+0]);
           //  assign pp_level4[i+0]=pp_level3[i+0]&pp_level3[i-8];     
              AND2_X1 and5 (pp_level3[i+0],pp_level3[i-8],pp_level4[i+0]);       
         end
       endgenerate
       //old_value_pass
       generate
       ...
       endgenerate 
        generate
             for (i = 23;i<64 ;i=i+32) begin:gen_block_sa320
            // assign gnpg_level5[i+0]=gnpg_level4[i+0]|pp_level4[i+0]&gnpg_level4[i-8];  
            AO21 a5 (pp_level4[i+0],gnpg_level4[i-8],gnpg_level4[i+0],gnpg_level5[i+0]);
           //  assign pp_level5[i+0]=pp_level4[i+0]&pp_level4[i-8];     
              AND2_X1 and5 (pp_level4[i+0],pp_level4[i-8],pp_level5[i+0]);       
         end
       endgenerate
       //old_value_pass
       generate
       ...
       endgenerate
        ...
        generate
             for (i = 23;i<64 ;i=i+32) begin:gen_block_sa328
            // assign gnpg_level5[i+8]=gnpg_level4[i+8]|pp_level4[i+8]&gnpg_level4[i-8];  
            AO21 a5 (pp_level4[i+8],gnpg_level4[i-8],gnpg_level4[i+8],gnpg_level5[i+8]);
           //  assign pp_level5[i+8]=pp_level4[i+8]&pp_level4[i-8];     
              AND2_X1 and5 (pp_level4[i+8],pp_level4[i-8],pp_level5[i+8]);       
         end
       endgenerate
       //old_value_pass
       generate
       ...
       endgenerate 
        generate
             for (i = 39;i<64 ;i=i+64) begin:gen_block_sa330
            // assign gnpg_level6[i+0]=gnpg_level5[i+0]|pp_level5[i+0]&gnpg_level5[i-8];  
            AO21 a5 (pp_level5[i+0],gnpg_level5[i-8],gnpg_level5[i+0],gnpg_level6[i+0]);
           //  assign pp_level6[i+0]=pp_level5[i+0]&pp_level5[i-8];     
              AND2_X1 and5 (pp_level5[i+0],pp_level5[i-8],pp_level6[i+0]);       
         end
       endgenerate
       //old_value_pass
       generate
       ...
       endgenerate
        ...
        generate
             for (i = 39;i<64 ;i=i+64) begin:gen_block_sa338
            // assign gnpg_level6[i+8]=gnpg_level5[i+8]|pp_level5[i+8]&gnpg_level5[i-8];  
            AO21 a5 (pp_level5[i+8],gnpg_level5[i-8],gnpg_level5[i+8],gnpg_level6[i+8]);
           //  assign pp_level6[i+8]=pp_level5[i+8]&pp_level5[i-8];     
              AND2_X1 and5 (pp_level5[i+8],pp_level5[i-8],pp_level6[i+8]);       
         end
       endgenerate
       //old_value_pass
       generate
       ...
       endgenerate
        ...
        generate
             for (i = 39;i<64 ;i=i+64) begin:gen_block_sa3316
            // assign gnpg_level6[i+16]=gnpg_level5[i+16]|pp_level5[i+16]&gnpg_level5[i-8];  
            AO21 a5 (pp_level5[i+16],gnpg_level5[i-8],gnpg_level5[i+16],gnpg_level6[i+16]);
           //  assign pp_level6[i+16]=pp_level5[i+16]&pp_level5[i-8];     
              AND2_X1 and5 (pp_level5[i+16],pp_level5[i-8],pp_level6[i+16]);       
         end
       endgenerate
       //old_value_pass
       generate
       ...
       endgenerate
        ...
        generate
             for (i = 39;i<64 ;i=i+64) begin:gen_block_sa3324
            // assign gnpg_level6[i+24]=gnpg_level5[i+24]|pp_level5[i+24]&gnpg_level5[i-8];  
            AO21 a5 (pp_level5[i+24],gnpg_level5[i-8],gnpg_level5[i+24],gnpg_level6[i+24]);
           //  assign pp_level6[i+24]=pp_level5[i+24]&pp_level5[i-8];     
              AND2_X1 and5 (pp_level5[i+24],pp_level5[i-8],pp_level6[i+24]);       
         end
       endgenerate
       //old_value_pass
       generate
