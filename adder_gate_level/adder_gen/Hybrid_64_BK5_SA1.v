...
wire cout_w;
reg cin_r;
Hybrid_64_BK5_SA1 u0 (a,b,cin_r,sum_w,cout_w);
...
module Hybrid_64_BK5_SA1 (a,b,cin,sum,cout);
...
wire [63:0] pp_level6;
            ...
            endgenerate 
             generate
              for (i = 16-1 ;i<64;i=i+16) begin:gen_block_sa24
               ...
               AND2_X1 and4 (pp_level3[i],pp_level3[i-8],pp_level4[i]);
              end
            endgenerate generate
            ...
            endgenerate 
             generate
              for (i = 32-1 ;i<64;i=i+32) begin:gen_block_sa25
                //assign gnpg_level5[i]=gnpg_level4[i]|pp_level4[i]&gnpg_level4[i-16];  
                  AO21 a4 (pp_level4[i],gnpg_level4[i-16],gnpg_level4[i],gnpg_level5[i]);
               // assign pp_level5[i]=pp_level4[i]&pp_level4[i-16];           
               AND2_X1 and4 (pp_level4[i],pp_level4[i-16],pp_level5[i]);
              end
            endgenerate generate
            ...
            endgenerate 
        generate
             for (i = 63;i<64 ;i=i+64) begin:gen_block_sa310
            // assign gnpg_level6[i+0]=gnpg_level5[i+0]|pp_level5[i+0]&gnpg_level5[i-32];  
            AO21 a5 (pp_level5[i+0],gnpg_level5[i-32],gnpg_level5[i+0],gnpg_level6[i+0]);
           //  assign pp_level6[i+0]=pp_level5[i+0]&pp_level5[i-32];     
              AND2_X1 and5 (pp_level5[i+0],pp_level5[i-32],pp_level6[i+0]);       
         end
       endgenerate
       //old_value_pass
       generate
             for (i = 95;i<64 ;i=i+64) begin
...
AO21 a9 (pp_level6[2],gnpg_level6[1],gnpg_level6[2],gnpg_level11[2]);
...
generate 
   for (i = 2;i<64/2 ;i=i+1 ) begin:gen_post_2
      ...
      AO21 a10 (pp_level6[2*i],gnpg_level10[i-2],gnpg_level6[2*i],gnpg_level11[2*i]);
   end
endgenerate
...
AO21 a11_4 (pp_level6[2+3],gnpg_level6[2+3-2],gnpg_level6[2+3],gnpg_level10[1]);
generate 

   for (i = 3;i<30;i=i+2 ) begin:gen_post_34
      // assign gnpg_level10[i]=gnpg_level6[2*i+3]|pp_level6[2*i+3]&gnpg_level9[(i-3)/2];
      AO21 a12 (pp_level6[2*i+3],gnpg_level9[(i-3)/2],gnpg_level6[2*i+3],gnpg_level10[i]);
   end
endgenerate
generate 
...
AO21 a11_3 (pp_level6[4+7],gnpg_level6[4+7-4],gnpg_level6[4+7],gnpg_level9[1]);
generate 

   for (i = 3;i<14;i=i+2 ) begin:gen_post_33
      // assign gnpg_level9[i]=gnpg_level6[4*i+7]|pp_level6[4*i+7]&gnpg_level8[(i-3)/2];
      AO21 a12 (pp_level6[4*i+7],gnpg_level8[(i-3)/2],gnpg_level6[4*i+7],gnpg_level9[i]);
   end
endgenerate
generate 
...
AO21 a11_2 (pp_level6[8+15],gnpg_level6[8+15-8],gnpg_level6[8+15],gnpg_level8[1]);
generate 

   for (i = 3;i<6;i=i+2 ) begin:gen_post_32
      // assign gnpg_level8[i]=gnpg_level6[8*i+15]|pp_level6[8*i+15]&gnpg_level7[(i-3)/2];
      AO21 a12 (pp_level6[8*i+15],gnpg_level7[(i-3)/2],gnpg_level6[8*i+15],gnpg_level8[i]);
   end
endgenerate
generate 
...
AO21 a13_1 (pp_level6[16+31],gnpg_level6[16+31-16],gnpg_level6[16+31],gnpg_level7[1]);
generate 
//1111
   for (i = 3;i<2;i=i+2 ) begin:gen_post_41
     // assign gnpg_level7[i]=gnpg_level6[16*i+31]|pp_level6[16*i+31]&gnpg_level6[16*i+31-16];
     AO21 a141 (pp_level6[16*i+31],gnpg_level6[16*i+31-16],gnpg_level6[16*i+31],gnpg_level7[i]);
   end
endgenerate
generate 
//1111
