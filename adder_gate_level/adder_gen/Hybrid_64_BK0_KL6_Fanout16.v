...
genvar i;
 ...
 wire [63:0] pp_level1;  
          // pre process
           generate
            for (i = 1;i<16 ;i=i+1 ) begin:genblock10
          ...
          // pre process
           generate
            for (i = 1;i<16 ;i=i+1 ) begin:genblock116
          ...
          // pre process
           generate
            for (i = 1;i<16 ;i=i+1 ) begin:genblock132
          ...
          // pre process
           generate
            for (i = 1;i<16 ;i=i+1 ) begin:genblock148
 ...
 wire [63:0] pp_level2;  
          // pre process continue last 3
           generate
            for (i = 2;i<16 ;i=i+1 ) begin:gen_kl_block20
   //         assign  gnpg_level2[0+i]=gnpg_level1[0+i]|pp_level1[0+i]&gnpg_level1[i+0-2]; 
          ...
          // pre process continue last 3
           generate
            for (i = 2;i<16 ;i=i+1 ) begin:gen_kl_block216
   //         assign  gnpg_level2[16+i]=gnpg_level1[16+i]|pp_level1[16+i]&gnpg_level1[i+16-2]; 
          ...
          // pre process continue last 3
           generate
            for (i = 2;i<16 ;i=i+1 ) begin:gen_kl_block232
   //         assign  gnpg_level2[32+i]=gnpg_level1[32+i]|pp_level1[32+i]&gnpg_level1[i+32-2]; 
          ...
          // pre process continue last 3
           generate
            for (i = 2;i<16 ;i=i+1 ) begin:gen_kl_block248
 ...
 wire [63:0] pp_level3;  
          // pre process continue last 2
           generate
            for (i = 4;i<16 ;i=i+1 ) begin:gen_kl_block30
   //         assign  gnpg_level3[0+i]=gnpg_level2[0+i]|pp_level2[0+i]&gnpg_level2[i+0-4]; 
          ...
          // pre process continue last 2
           generate
            for (i = 4;i<16 ;i=i+1 ) begin:gen_kl_block316
   //         assign  gnpg_level3[16+i]=gnpg_level2[16+i]|pp_level2[16+i]&gnpg_level2[i+16-4]; 
          ...
          // pre process continue last 2
           generate
            for (i = 4;i<16 ;i=i+1 ) begin:gen_kl_block332
   //         assign  gnpg_level3[32+i]=gnpg_level2[32+i]|pp_level2[32+i]&gnpg_level2[i+32-4]; 
          ...
          // pre process continue last 2
           generate
            for (i = 4;i<16 ;i=i+1 ) begin:gen_kl_block348
 ...
 wire [63:0] pp_level4;  
          // pre process continue last 1
           generate
            for (i = 8;i<16 ;i=i+1 ) begin:gen_kl_block40
   //         assign  gnpg_level4[0+i]=gnpg_level3[0+i]|pp_level3[0+i]&gnpg_level3[i+0-8]; 
          ...
          // pre process continue last 1
           generate
            for (i = 8;i<16 ;i=i+1 ) begin:gen_kl_block416
   //         assign  gnpg_level4[16+i]=gnpg_level3[16+i]|pp_level3[16+i]&gnpg_level3[i+16-8]; 
            AO21 a2 (pp_level3[16+i],gnpg_level3[i+16-8],gnpg_level3[16+i],gnpg_level4[16+i]);
            //  assign  pp_level4[16+i]=pp_level3[16+i]&pp_level3[i+16-8];
            AND2_X1 and2 (pp_level3[16+i],pp_level3[i+16-8],pp_level4[16+i]);
            end
           endgenerate
          
          // pre process continue last 1
           generate
            for (i = 8;i<16 ;i=i+1 ) begin:gen_kl_block432
   //         assign  gnpg_level4[32+i]=gnpg_level3[32+i]|pp_level3[32+i]&gnpg_level3[i+32-8]; 
          ...
          // pre process continue last 1
           generate
            for (i = 8;i<16 ;i=i+1 ) begin:gen_kl_block448
   //         assign  gnpg_level4[48+i]=gnpg_level3[48+i]|pp_level3[48+i]&gnpg_level3[i+48-8]; 
            AO21 a2 (pp_level3[48+i],gnpg_level3[i+48-8],gnpg_level3[48+i],gnpg_level4[48+i]);
            //  assign  pp_level4[48+i]=pp_level3[48+i]&pp_level3[i+48-8];
            AND2_X1 and2 (pp_level3[48+i],pp_level3[i+48-8],pp_level4[48+i]);
            end
           endgenerate
 ...
 wire [63:0] pp_level5;  
         ...
         generate
           for (i = 16;i<16+16 ;i=i+1) begin:gen_mul_kl_block516
             // assign  gnpg_level5[i]=gnpg_level4[i]|pp_level4[i]&gnpg_level4[16+16-1-16];
              AO21 a3 (pp_level4[i],gnpg_level4[16+16-1-16],gnpg_level4[i],gnpg_level5[i]);
            //   assign  pp_level5[i]=pp_level4[i]&pp_level4[16+16-1-16];
            AND2_X1 and3 (pp_level4[i],pp_level4[16+16-1-16],pp_level5[i]);
           end 
         endgenerate
         
         // Multiple fanout stage
         generate
           for (i = 32;i<16+32 ;i=i+1) begin:gen_mul_kl_block532
             // assign  gnpg_level5[i]=gnpg_level4[i]|pp_level4[i]&gnpg_level4[32+16-1-16];
              AO21 a3 (pp_level4[i],gnpg_level4[32+16-1-16],gnpg_level4[i],gnpg_level5[i]);
            //   assign  pp_level5[i]=pp_level4[i]&pp_level4[32+16-1-16];
            AND2_X1 and3 (pp_level4[i],pp_level4[32+16-1-16],pp_level5[i]);
           end 
         endgenerate
         
         // Multiple fanout stage
         generate
           for (i = 48;i<16+48 ;i=i+1) begin:gen_mul_kl_block548
             // assign  gnpg_level5[i]=gnpg_level4[i]|pp_level4[i]&gnpg_level4[48+16-1-16];
              AO21 a3 (pp_level4[i],gnpg_level4[48+16-1-16],gnpg_level4[i],gnpg_level5[i]);
            //   assign  pp_level5[i]=pp_level4[i]&pp_level4[48+16-1-16];
            AND2_X1 and3 (pp_level4[i],pp_level4[48+16-1-16],pp_level5[i]);
           end 
         endgenerate
 ...
 wire [63:0] pp_level6;  
         ...
         // Multiple fanout stage
         generate
           for (i = 32;i<16+32 ;i=i+1) begin:gen_mul_kl_block632
             // assign  gnpg_level6[i]=gnpg_level5[i]|pp_level5[i]&gnpg_level5[32+16-1-32];
              AO21 a3 (pp_level5[i],gnpg_level5[32+16-1-32],gnpg_level5[i],gnpg_level6[i]);
            //   assign  pp_level6[i]=pp_level5[i]&pp_level5[32+16-1-32];
            AND2_X1 and3 (pp_level5[i],pp_level5[32+16-1-32],pp_level6[i]);
           end 
         endgenerate
         
         // Multiple fanout stage
         generate
           for (i = 48;i<16+48 ;i=i+1) begin:gen_mul_kl_block648
             // assign  gnpg_level6[i]=gnpg_level5[i]|pp_level5[i]&gnpg_level5[48+16-1-32];
              AO21 a3 (pp_level5[i],gnpg_level5[48+16-1-32],gnpg_level5[i],gnpg_level6[i]);
            //   assign  pp_level6[i]=pp_level5[i]&pp_level5[48+16-1-32];
            AND2_X1 and3 (pp_level5[i],pp_level5[48+16-1-32],pp_level6[i]);
           end 
         endgenerate
