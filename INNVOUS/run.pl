...
set init_verilog /home/shi/DC_AUTO/asap7_for_pr/${top_module}_${fre}.v
...
create_constraint_mode -name _default_constraint_mode_ -sdc_files {/home/shi/DC_AUTO/asap7_for_pr/${top_module}_${fre}.sdc }
...
set lef_4x \"/home/shi/asap7/asap7sc7p5t_28/techlef_misc/asap7_tech_4x_201209.lef /home/shi/asap7/asap7sc7p5t_28/LEF/scaled/asap7sc7p5t_28_SL_4x_220121a.lef\" \n ";
...
open (DATA4, ">>/home/shi/adder_pr/asap7/def/_unit_change.sh") or die "_unit_change.sh文件无法打开, $!";

print DATA4 "
python3  /home/shi/adder_pr/asap7/def/_unit_.py    /home/shi/adder_pr/asap7/def/${top_module}_${lefnumber}x_${fre}.def 
";
close (DATA4);
