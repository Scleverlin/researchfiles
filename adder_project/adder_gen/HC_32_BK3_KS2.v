...
module HC_32_BK3_KS2_top (a,b,cin,sum,cout,clk,rst);
input [63:0]a;
input [63:0]b;
input cin;
output reg [63:0]sum;
...
wire cout_w;
reg cin_r;
HC_32_BK3_KS2 u0 (a,b,cin_r,sum_w,cout_w);
...
module HC_32_BK3_KS2 (a,b,cin,sum,cout);
