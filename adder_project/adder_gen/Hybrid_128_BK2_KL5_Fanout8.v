...
module Hybrid_128_BK2_KL5_Fanout8_top (a,b,cin,sum,cout,clk,rst);
input [63:0]a;
input [63:0]b;
input cin;
output reg [63:0]sum;
...
wire cout_w;
reg cin_r;
Hybrid_128_BK2_KL5_Fanout8 u0 (a,b,cin_r,sum_w,cout_w);
...
module Hybrid_128_BK2_KL5_Fanout8 (a,b,cin,sum,cout);
...
wire [127:0] pp_level7;
         ...
         // strange part
          ...
          // pre process continue last 1
           generate
            for (i = 16;i<4*8 ;i=i+4) begin
              assign  gnpg_level5[99+i]=gnpg_level4[99+i]|pp_level4[99+i]&gnpg_level4[i+99-16]; 
              assign  pp_level5[99+i]=pp_level4[99+i]&pp_level4[i+99-16];
            end
           endgenerate
         ...
         // strange part
            generate
            for (i = 0;i<16 ;i=i+4 ) begin
              assign  gnpg_level5[99+i]=gnpg_level4[99+i]; 
              assign  pp_level5[99+i]=pp_level4[99+i];
            end 
            endgenerate
          // before start point
            generate
         ...
         generate
           for (i = 35;i<4*8+35 ;i=i+4) begin
              assign  gnpg_level6[i]=gnpg_level5[i]|pp_level5[i]&gnpg_level5[35+4*8-4-4*8];
              assign  pp_level6[i]=pp_level5[i]&pp_level5[35+4*8-4-4*8];
           end 
         endgenerate
         
         // Multiple fanout stage
         generate
           for (i = 67;i<4*8+67 ;i=i+4) begin
              assign  gnpg_level6[i]=gnpg_level5[i]|pp_level5[i]&gnpg_level5[67+4*8-4-4*8];
              assign  pp_level6[i]=pp_level5[i]&pp_level5[67+4*8-4-4*8];
           end 
         endgenerate
         
         // Multiple fanout stage
         generate
           for (i = 99;i<4*8+99 ;i=i+4) begin
              assign  gnpg_level6[i]=gnpg_level5[i]|pp_level5[i]&gnpg_level5[99+4*8-4-4*8];
              assign  pp_level6[i]=pp_level5[i]&pp_level5[99+4*8-4-4*8];
           end 
         endgenerate
         ...
         generate
           for (i = 67;i<4*8+67 ;i=i+4) begin
              assign  gnpg_level7[i]=gnpg_level6[i]|pp_level6[i]&gnpg_level6[67+4*8-4-4*16];
              assign  pp_level7[i]=pp_level6[i]&pp_level6[67+4*8-4-4*16];
           end 
         endgenerate
         ...
         generate
           for (i = 99;i<4*8+99 ;i=i+4) begin
              assign  gnpg_level7[i]=gnpg_level6[i]|pp_level6[i]&gnpg_level6[99+4*8-4-4*16];
              assign  pp_level7[i]=pp_level6[i]&pp_level6[99+4*8-4-4*16];
           end 
         endgenerate
