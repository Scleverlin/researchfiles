...
module Hybrid_128_BK3_KL4_Fanout4_top (a,b,cin,sum,cout,clk,rst);
input [127:0]a;
input [127:0]b;
input cin;
...
wire cout_w;
reg cin_r;
Hybrid_128_BK3_KL4_Fanout4 u0 (a,b,cin_r,sum_w,cout_w);
...
module Hybrid_128_BK3_KL4_Fanout4 (a,b,cin,sum,cout);
...
wire [127:0] pp_level7;
         ...
         // strange part
          ...
          // pre process continue last 1
           generate
            for (i = 16;i<8*4 ;i=i+8) begin
              assign  gnpg_level5[7+i]=gnpg_level4[7+i]|pp_level4[7+i]&gnpg_level4[i+7-16]; 
              assign  pp_level5[7+i]=pp_level4[7+i]&pp_level4[i+7-16];
            end
           endgenerate
          ...
          // pre process continue last 1
           generate
            for (i = 16;i<8*4 ;i=i+8) begin
              assign  gnpg_level5[39+i]=gnpg_level4[39+i]|pp_level4[39+i]&gnpg_level4[i+39-16]; 
              assign  pp_level5[39+i]=pp_level4[39+i]&pp_level4[i+39-16];
            end
           endgenerate
          ...
          // pre process continue last 1
           generate
            for (i = 16;i<8*4 ;i=i+8) begin
              assign  gnpg_level5[71+i]=gnpg_level4[71+i]|pp_level4[71+i]&gnpg_level4[i+71-16]; 
              assign  pp_level5[71+i]=pp_level4[71+i]&pp_level4[i+71-16];
            end
           endgenerate
          ...
          // pre process continue last 1
           generate
            for (i = 16;i<8*4 ;i=i+8) begin
              assign  gnpg_level5[103+i]=gnpg_level4[103+i]|pp_level4[103+i]&gnpg_level4[i+103-16]; 
              assign  pp_level5[103+i]=pp_level4[103+i]&pp_level4[i+103-16];
            end
           endgenerate
         ...
         // strange part
            ...
            for (i = 0;i<16 ;i=i+8 ) begin
              assign  gnpg_level5[39+i]=gnpg_level4[39+i]; 
              assign  pp_level5[39+i]=pp_level4[39+i];
            end 
            endgenerate
         // strange part
            generate
            for (i = 0;i<16 ;i=i+8 ) begin
              assign  gnpg_level5[71+i]=gnpg_level4[71+i]; 
              assign  pp_level5[71+i]=pp_level4[71+i];
            end 
            endgenerate
         // strange part
            generate
            for (i = 0;i<16 ;i=i+8 ) begin
              assign  gnpg_level5[103+i]=gnpg_level4[103+i]; 
              assign  pp_level5[103+i]=pp_level4[103+i];
            end 
            endgenerate
          // before start point
            generate
         ...
         // Multiple fanout stage
         generate
           for (i = 71;i<8*4+71 ;i=i+8) begin
              assign  gnpg_level6[i]=gnpg_level5[i]|pp_level5[i]&gnpg_level5[71+8*4-8-8*4];
              assign  pp_level6[i]=pp_level5[i]&pp_level5[71+8*4-8-8*4];
           end 
         endgenerate
         
         // Multiple fanout stage
         generate
           for (i = 103;i<8*4+103 ;i=i+8) begin
              assign  gnpg_level6[i]=gnpg_level5[i]|pp_level5[i]&gnpg_level5[103+8*4-8-8*4];
              assign  pp_level6[i]=pp_level5[i]&pp_level5[103+8*4-8-8*4];
           end 
         endgenerate
         ...
         generate
           for (i = 71;i<8*4+71 ;i=i+8) begin
              assign  gnpg_level7[i]=gnpg_level6[i]|pp_level6[i]&gnpg_level6[71+8*4-8-8*8];
              assign  pp_level7[i]=pp_level6[i]&pp_level6[71+8*4-8-8*8];
           end 
         endgenerate
         ...
         generate
           for (i = 103;i<8*4+103 ;i=i+8) begin
              assign  gnpg_level7[i]=gnpg_level6[i]|pp_level6[i]&gnpg_level6[103+8*4-8-8*8];
              assign  pp_level7[i]=pp_level6[i]&pp_level6[103+8*4-8-8*8];
           end 
         endgenerate
