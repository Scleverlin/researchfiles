...
module Hybrid_128_BK5_SA2_top (a,b,cin,sum,cout,clk,rst);
input [127:0]a;
input [127:0]b;
input cin;
...
wire cout_w;
reg cin_r;
Hybrid_128_BK5_SA2 u0 (a,b,cin_r,sum_w,cout_w);
...
module Hybrid_128_BK5_SA2 (a,b,cin,sum,cout);
...
wire [127:0] pp_level7;
            ...
            endgenerate 
        generate
             for (i = 63;i<128 ;i=i+64) begin
             assign gnpg_level6[i+0]=gnpg_level5[i+0]|pp_level5[i+0]&gnpg_level5[i-32];  
             assign pp_level6[i+0]=pp_level5[i+0]&pp_level5[i-32];            
         end
       endgenerate
       //old_value_pass
       generate
             for (i = 95;i<128 ;i=i+64) begin
       ...
       endgenerate 
        generate
             for (i = 95;i<128 ;i=i+128) begin
             assign gnpg_level7[i+0]=gnpg_level6[i+0]|pp_level6[i+0]&gnpg_level6[i-32];  
             assign pp_level7[i+0]=pp_level6[i+0]&pp_level6[i-32];            
         end
       endgenerate
       //old_value_pass
       generate
             for (i = 159;i<128 ;i=i+128) begin
       ...
       endgenerate
        ...
        generate
             for (i = 95;i<128 ;i=i+128) begin
             assign gnpg_level7[i+32]=gnpg_level6[i+32]|pp_level6[i+32]&gnpg_level6[i-32];  
             assign pp_level7[i+32]=pp_level6[i+32]&pp_level6[i-32];            
         end
       endgenerate
       //old_value_pass
       generate
