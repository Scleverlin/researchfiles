...
module Hybrid_128_BK3_SA4_top (a,b,cin,sum,cout,clk,rst);
input [127:0]a;
input [127:0]b;
input cin;
...
wire cout_w;
reg cin_r;
Hybrid_128_BK3_SA4 u0 (a,b,cin_r,sum_w,cout_w);
...
module Hybrid_128_BK3_SA4 (a,b,cin,sum,cout);
...
wire [127:0] pp_level7;
       ...
       endgenerate 
        generate
             for (i = 71;i<128 ;i=i+128) begin
             assign gnpg_level7[i+0]=gnpg_level6[i+0]|pp_level6[i+0]&gnpg_level6[i-8];  
             assign pp_level7[i+0]=pp_level6[i+0]&pp_level6[i-8];            
         end
       endgenerate
       //old_value_pass
       generate
             for (i = 135;i<128 ;i=i+128) begin
       ...
       endgenerate
        ...
        generate
             for (i = 71;i<128 ;i=i+128) begin
             assign gnpg_level7[i+8]=gnpg_level6[i+8]|pp_level6[i+8]&gnpg_level6[i-8];  
             assign pp_level7[i+8]=pp_level6[i+8]&pp_level6[i-8];            
         end
       endgenerate
       //old_value_pass
       generate
       ...
       endgenerate
        ...
        generate
             for (i = 71;i<128 ;i=i+128) begin
             assign gnpg_level7[i+16]=gnpg_level6[i+16]|pp_level6[i+16]&gnpg_level6[i-8];  
             assign pp_level7[i+16]=pp_level6[i+16]&pp_level6[i-8];            
         end
       endgenerate
       //old_value_pass
       generate
       ...
       endgenerate
        ...
        generate
             for (i = 71;i<128 ;i=i+128) begin
             assign gnpg_level7[i+24]=gnpg_level6[i+24]|pp_level6[i+24]&gnpg_level6[i-8];  
             assign pp_level7[i+24]=pp_level6[i+24]&pp_level6[i-8];            
         end
       endgenerate
       //old_value_pass
       generate
       ...
       endgenerate
        ...
        generate
             for (i = 71;i<128 ;i=i+128) begin
             assign gnpg_level7[i+32]=gnpg_level6[i+32]|pp_level6[i+32]&gnpg_level6[i-8];  
             assign pp_level7[i+32]=pp_level6[i+32]&pp_level6[i-8];            
         end
       endgenerate
       //old_value_pass
       generate
       ...
       endgenerate
        ...
        generate
             for (i = 71;i<128 ;i=i+128) begin
             assign gnpg_level7[i+40]=gnpg_level6[i+40]|pp_level6[i+40]&gnpg_level6[i-8];  
             assign pp_level7[i+40]=pp_level6[i+40]&pp_level6[i-8];            
         end
       endgenerate
       //old_value_pass
       generate
       ...
       endgenerate
        ...
        generate
             for (i = 71;i<128 ;i=i+128) begin
             assign gnpg_level7[i+48]=gnpg_level6[i+48]|pp_level6[i+48]&gnpg_level6[i-8];  
             assign pp_level7[i+48]=pp_level6[i+48]&pp_level6[i-8];            
         end
       endgenerate
       //old_value_pass
       generate
       ...
       endgenerate
        ...
        generate
             for (i = 71;i<128 ;i=i+128) begin
             assign gnpg_level7[i+56]=gnpg_level6[i+56]|pp_level6[i+56]&gnpg_level6[i-8];  
             assign pp_level7[i+56]=pp_level6[i+56]&pp_level6[i-8];            
         end
       endgenerate
       //old_value_pass
       generate
