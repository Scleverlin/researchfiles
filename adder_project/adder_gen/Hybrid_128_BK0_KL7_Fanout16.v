...
module Hybrid_128_BK0_KL7_Fanout16_top (a,b,cin,sum,cout,clk,rst);
input [63:0]a;
input [63:0]b;
input cin;
output reg [63:0]sum;
...
wire cout_w;
reg cin_r;
Hybrid_128_BK0_KL7_Fanout16 u0 (a,b,cin_r,sum_w,cout_w);
...
module Hybrid_128_BK0_KL7_Fanout16 (a,b,cin,sum,cout);
...
genvar i;
 ...
 wire [127:0] pp_level4;  
          ...
          // pre process continue last 1
           generate
            for (i = 8;i<16 ;i=i+1 ) begin
              assign  gnpg_level4[80+i]=gnpg_level3[80+i]|pp_level3[80+i]&gnpg_level3[i+80-8]; 
              assign  pp_level4[80+i]=pp_level3[80+i]&pp_level3[i+80-8];
            end
           endgenerate
          ...
          // pre process continue last 1
           generate
            for (i = 8;i<16 ;i=i+1 ) begin
              assign  gnpg_level4[112+i]=gnpg_level3[112+i]|pp_level3[112+i]&gnpg_level3[i+112-8]; 
              assign  pp_level4[112+i]=pp_level3[112+i]&pp_level3[i+112-8];
            end
           endgenerate
            ...
            generate
            for (i = 0;i<8 ;i=i+1 ) begin
              assign  gnpg_level4[80+i]=gnpg_level3[80+i]; 
              assign  pp_level4[80+i]=pp_level3[80+i];
            end 
            endgenerate
            generate
            for (i = 0;i<8 ;i=i+1 ) begin
            ...
            generate
            for (i = 0;i<8 ;i=i+1 ) begin
              assign  gnpg_level4[112+i]=gnpg_level3[112+i]; 
              assign  pp_level4[112+i]=pp_level3[112+i];
            end 
            endgenerate
 ...
 wire [127:0] pp_level5;  
         ...
         generate
           for (i = 32;i<16+32 ;i=i+1) begin
              assign  gnpg_level5[i]=gnpg_level4[i]|pp_level4[i]&gnpg_level4[32+16-1-16];
              assign  pp_level5[i]=pp_level4[i]&pp_level4[32+16-1-16];
           end 
         endgenerate
         ...
         generate
           for (i = 48;i<16+48 ;i=i+1) begin
              assign  gnpg_level5[i]=gnpg_level4[i]|pp_level4[i]&gnpg_level4[48+16-1-16];
              assign  pp_level5[i]=pp_level4[i]&pp_level4[48+16-1-16];
           end 
         endgenerate
         
         // Multiple fanout stage
         generate
           for (i = 64;i<16+64 ;i=i+1) begin
              assign  gnpg_level5[i]=gnpg_level4[i]|pp_level4[i]&gnpg_level4[64+16-1-16];
              assign  pp_level5[i]=pp_level4[i]&pp_level4[64+16-1-16];
           end 
         endgenerate
         
         // Multiple fanout stage
         generate
           for (i = 80;i<16+80 ;i=i+1) begin
              assign  gnpg_level5[i]=gnpg_level4[i]|pp_level4[i]&gnpg_level4[80+16-1-16];
              assign  pp_level5[i]=pp_level4[i]&pp_level4[80+16-1-16];
           end 
         endgenerate
         
         // Multiple fanout stage
         generate
           for (i = 96;i<16+96 ;i=i+1) begin
              assign  gnpg_level5[i]=gnpg_level4[i]|pp_level4[i]&gnpg_level4[96+16-1-16];
              assign  pp_level5[i]=pp_level4[i]&pp_level4[96+16-1-16];
           end 
         endgenerate
         
         // Multiple fanout stage
         generate
           for (i = 112;i<16+112 ;i=i+1) begin
              assign  gnpg_level5[i]=gnpg_level4[i]|pp_level4[i]&gnpg_level4[112+16-1-16];
              assign  pp_level5[i]=pp_level4[i]&pp_level4[112+16-1-16];
           end 
         endgenerate
 ...
 wire [127:0] pp_level6;  
         ...
         generate
           for (i = 32;i<16+32 ;i=i+1) begin
              assign  gnpg_level6[i]=gnpg_level5[i]|pp_level5[i]&gnpg_level5[32+16-1-32];
              assign  pp_level6[i]=pp_level5[i]&pp_level5[32+16-1-32];
           end 
         endgenerate
         ...
         generate
           for (i = 48;i<16+48 ;i=i+1) begin
              assign  gnpg_level6[i]=gnpg_level5[i]|pp_level5[i]&gnpg_level5[48+16-1-32];
              assign  pp_level6[i]=pp_level5[i]&pp_level5[48+16-1-32];
           end 
         endgenerate
         ...
         generate
           for (i = 64;i<16+64 ;i=i+1) begin
              assign  gnpg_level6[i]=gnpg_level5[i]|pp_level5[i]&gnpg_level5[64+16-1-32];
              assign  pp_level6[i]=pp_level5[i]&pp_level5[64+16-1-32];
           end 
         endgenerate
         ...
         generate
           for (i = 80;i<16+80 ;i=i+1) begin
              assign  gnpg_level6[i]=gnpg_level5[i]|pp_level5[i]&gnpg_level5[80+16-1-32];
              assign  pp_level6[i]=pp_level5[i]&pp_level5[80+16-1-32];
           end 
         endgenerate
         ...
         generate
           for (i = 96;i<16+96 ;i=i+1) begin
              assign  gnpg_level6[i]=gnpg_level5[i]|pp_level5[i]&gnpg_level5[96+16-1-32];
              assign  pp_level6[i]=pp_level5[i]&pp_level5[96+16-1-32];
           end 
         endgenerate
         ...
         generate
           for (i = 112;i<16+112 ;i=i+1) begin
              assign  gnpg_level6[i]=gnpg_level5[i]|pp_level5[i]&gnpg_level5[112+16-1-32];
              assign  pp_level6[i]=pp_level5[i]&pp_level5[112+16-1-32];
           end 
         endgenerate
 ...
 wire [127:0] pp_level7;  
         ...
         generate
           for (i = 64;i<16+64 ;i=i+1) begin
              assign  gnpg_level7[i]=gnpg_level6[i]|pp_level6[i]&gnpg_level6[64+16-1-64];
              assign  pp_level7[i]=pp_level6[i]&pp_level6[64+16-1-64];
           end 
         endgenerate
         ...
         generate
           for (i = 80;i<16+80 ;i=i+1) begin
              assign  gnpg_level7[i]=gnpg_level6[i]|pp_level6[i]&gnpg_level6[80+16-1-64];
              assign  pp_level7[i]=pp_level6[i]&pp_level6[80+16-1-64];
           end 
         endgenerate
         ...
         generate
           for (i = 96;i<16+96 ;i=i+1) begin
              assign  gnpg_level7[i]=gnpg_level6[i]|pp_level6[i]&gnpg_level6[96+16-1-64];
              assign  pp_level7[i]=pp_level6[i]&pp_level6[96+16-1-64];
           end 
         endgenerate
         ...
         generate
           for (i = 112;i<16+112 ;i=i+1) begin
              assign  gnpg_level7[i]=gnpg_level6[i]|pp_level6[i]&gnpg_level6[112+16-1-64];
              assign  pp_level7[i]=pp_level6[i]&pp_level6[112+16-1-64];
           end 
         endgenerate
