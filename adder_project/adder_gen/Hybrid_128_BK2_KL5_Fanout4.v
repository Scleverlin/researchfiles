...
module Hybrid_128_BK2_KL5_Fanout4_top (a,b,cin,sum,cout,clk,rst);
input [63:0]a;
input [63:0]b;
input cin;
output reg [63:0]sum;
...
wire cout_w;
reg cin_r;
Hybrid_128_BK2_KL5_Fanout4 u0 (a,b,cin_r,sum_w,cout_w);
...
module Hybrid_128_BK2_KL5_Fanout4 (a,b,cin,sum,cout);
...
wire [127:0] pp_level7;
         ...
         // strange part
          ...
          // pre process continue last 1
           generate
            for (i = 8;i<4*4 ;i=i+4) begin
              assign  gnpg_level4[83+i]=gnpg_level3[83+i]|pp_level3[83+i]&gnpg_level3[i+83-8]; 
              assign  pp_level4[83+i]=pp_level3[83+i]&pp_level3[i+83-8];
            end
           endgenerate
          ...
          // pre process continue last 1
           generate
            for (i = 8;i<4*4 ;i=i+4) begin
              assign  gnpg_level4[99+i]=gnpg_level3[99+i]|pp_level3[99+i]&gnpg_level3[i+99-8]; 
              assign  pp_level4[99+i]=pp_level3[99+i]&pp_level3[i+99-8];
            end
           endgenerate
          ...
          // pre process continue last 1
           generate
            for (i = 8;i<4*4 ;i=i+4) begin
              assign  gnpg_level4[115+i]=gnpg_level3[115+i]|pp_level3[115+i]&gnpg_level3[i+115-8]; 
              assign  pp_level4[115+i]=pp_level3[115+i]&pp_level3[i+115-8];
            end
           endgenerate
         ...
         // strange part
            generate
            for (i = 0;i<8 ;i=i+4 ) begin
              assign  gnpg_level4[83+i]=gnpg_level3[83+i]; 
              assign  pp_level4[83+i]=pp_level3[83+i];
            end 
            endgenerate
         // strange part
            generate
            for (i = 0;i<8 ;i=i+4 ) begin
              assign  gnpg_level4[99+i]=gnpg_level3[99+i]; 
              assign  pp_level4[99+i]=pp_level3[99+i];
            end 
            endgenerate
         // strange part
            generate
            for (i = 0;i<8 ;i=i+4 ) begin
              assign  gnpg_level4[115+i]=gnpg_level3[115+i]; 
              assign  pp_level4[115+i]=pp_level3[115+i];
            end 
            endgenerate
          // before start point
            generate
         ...
         // Multiple fanout stage
         generate
           for (i = 67;i<4*4+67 ;i=i+4) begin
              assign  gnpg_level5[i]=gnpg_level4[i]|pp_level4[i]&gnpg_level4[67+4*4-4-4*4];
              assign  pp_level5[i]=pp_level4[i]&pp_level4[67+4*4-4-4*4];
           end 
         endgenerate
         
         // Multiple fanout stage
         generate
           for (i = 83;i<4*4+83 ;i=i+4) begin
              assign  gnpg_level5[i]=gnpg_level4[i]|pp_level4[i]&gnpg_level4[83+4*4-4-4*4];
              assign  pp_level5[i]=pp_level4[i]&pp_level4[83+4*4-4-4*4];
           end 
         endgenerate
         
         // Multiple fanout stage
         generate
           for (i = 99;i<4*4+99 ;i=i+4) begin
              assign  gnpg_level5[i]=gnpg_level4[i]|pp_level4[i]&gnpg_level4[99+4*4-4-4*4];
              assign  pp_level5[i]=pp_level4[i]&pp_level4[99+4*4-4-4*4];
           end 
         endgenerate
         
         // Multiple fanout stage
         generate
           for (i = 115;i<4*4+115 ;i=i+4) begin
              assign  gnpg_level5[i]=gnpg_level4[i]|pp_level4[i]&gnpg_level4[115+4*4-4-4*4];
              assign  pp_level5[i]=pp_level4[i]&pp_level4[115+4*4-4-4*4];
           end 
         endgenerate
         ...
         generate
           for (i = 67;i<4*4+67 ;i=i+4) begin
              assign  gnpg_level6[i]=gnpg_level5[i]|pp_level5[i]&gnpg_level5[67+4*4-4-4*8];
              assign  pp_level6[i]=pp_level5[i]&pp_level5[67+4*4-4-4*8];
           end 
         endgenerate
         ...
         generate
           for (i = 83;i<4*4+83 ;i=i+4) begin
              assign  gnpg_level6[i]=gnpg_level5[i]|pp_level5[i]&gnpg_level5[83+4*4-4-4*8];
              assign  pp_level6[i]=pp_level5[i]&pp_level5[83+4*4-4-4*8];
           end 
         endgenerate
         ...
         generate
           for (i = 99;i<4*4+99 ;i=i+4) begin
              assign  gnpg_level6[i]=gnpg_level5[i]|pp_level5[i]&gnpg_level5[99+4*4-4-4*8];
              assign  pp_level6[i]=pp_level5[i]&pp_level5[99+4*4-4-4*8];
           end 
         endgenerate
         ...
         generate
           for (i = 115;i<4*4+115 ;i=i+4) begin
              assign  gnpg_level6[i]=gnpg_level5[i]|pp_level5[i]&gnpg_level5[115+4*4-4-4*8];
              assign  pp_level6[i]=pp_level5[i]&pp_level5[115+4*4-4-4*8];
           end 
         endgenerate
         ...
         generate
           for (i = 67;i<4*4+67 ;i=i+4) begin
              assign  gnpg_level7[i]=gnpg_level6[i]|pp_level6[i]&gnpg_level6[67+4*4-4-4*16];
              assign  pp_level7[i]=pp_level6[i]&pp_level6[67+4*4-4-4*16];
           end 
         endgenerate
         ...
         generate
           for (i = 83;i<4*4+83 ;i=i+4) begin
              assign  gnpg_level7[i]=gnpg_level6[i]|pp_level6[i]&gnpg_level6[83+4*4-4-4*16];
              assign  pp_level7[i]=pp_level6[i]&pp_level6[83+4*4-4-4*16];
           end 
         endgenerate
         ...
         generate
           for (i = 99;i<4*4+99 ;i=i+4) begin
              assign  gnpg_level7[i]=gnpg_level6[i]|pp_level6[i]&gnpg_level6[99+4*4-4-4*16];
              assign  pp_level7[i]=pp_level6[i]&pp_level6[99+4*4-4-4*16];
           end 
         endgenerate
         ...
         generate
           for (i = 115;i<4*4+115 ;i=i+4) begin
              assign  gnpg_level7[i]=gnpg_level6[i]|pp_level6[i]&gnpg_level6[115+4*4-4-4*16];
              assign  pp_level7[i]=pp_level6[i]&pp_level6[115+4*4-4-4*16];
           end 
         endgenerate
