...
module Hybrid_16_BK1_KL3_Fanout4_top (a,b,cin,sum,cout,clk,rst);
input [15:0]a;
input [15:0]b;
input cin;
output reg [15:0]sum;
...
wire cout_w;
reg cin_r;
Hybrid_16_BK1_KL3_Fanout4 u0 (a,b,cin_r,sum_w,cout_w);
...
module Hybrid_16_BK1_KL3_Fanout4 (a,b,cin,sum,cout);
