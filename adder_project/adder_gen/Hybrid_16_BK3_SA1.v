...
module Hybrid_16_BK3_SA1_top (a,b,cin,sum,cout,clk,rst);
input [63:0]a;
input [63:0]b;
input cin;
output reg [63:0]sum;
...
wire cout_w;
reg cin_r;
Hybrid_16_BK3_SA1 u0 (a,b,cin_r,sum_w,cout_w);
...
module Hybrid_16_BK3_SA1 (a,b,cin,sum,cout);
