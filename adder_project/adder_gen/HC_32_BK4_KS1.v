...
module HC_32_BK4_KS1_top (a,b,cin,sum,cout,clk,rst);
input [31:0]a;
input [31:0]b;
input cin;
output reg [31:0]sum;
...
wire cout_w;
reg cin_r;
HC_32_BK4_KS1 u0 (a,b,cin_r,sum_w,cout_w);
...
module HC_32_BK4_KS1 (a,b,cin,sum,cout);
