...
module Hybrid_128_BK1_KL6_Fanout32_top (a,b,cin,sum,cout,clk,rst);
input [127:0]a;
input [127:0]b;
input cin;
...
wire cout_w;
reg cin_r;
Hybrid_128_BK1_KL6_Fanout32 u0 (a,b,cin_r,sum_w,cout_w);
...
module Hybrid_128_BK1_KL6_Fanout32 (a,b,cin,sum,cout);
...
wire [127:0] pp_level7;
         ...
         // strange part
          ...
          // pre process continue last 1
           generate
            for (i = 32;i<2*32 ;i=i+2) begin
              assign  gnpg_level6[1+i]=gnpg_level5[1+i]|pp_level5[1+i]&gnpg_level5[i+1-32]; 
              assign  pp_level6[1+i]=pp_level5[1+i]&pp_level5[i+1-32];
            end
           endgenerate
          ...
          // pre process continue last 1
           generate
            for (i = 32;i<2*32 ;i=i+2) begin
              assign  gnpg_level6[65+i]=gnpg_level5[65+i]|pp_level5[65+i]&gnpg_level5[i+65-32]; 
              assign  pp_level6[65+i]=pp_level5[65+i]&pp_level5[i+65-32];
            end
           endgenerate
         ...
         // strange part
            ...
            for (i = 0;i<32 ;i=i+2 ) begin
              assign  gnpg_level6[65+i]=gnpg_level5[65+i]; 
              assign  pp_level6[65+i]=pp_level5[65+i];
            end 
            endgenerate
          // before start point
            generate
         ...
         generate
           for (i = 65;i<2*32+65 ;i=i+2) begin
              assign  gnpg_level7[i]=gnpg_level6[i]|pp_level6[i]&gnpg_level6[65+2*32-2-2*32];
              assign  pp_level7[i]=pp_level6[i]&pp_level6[65+2*32-2-2*32];
           end 
         endgenerate
