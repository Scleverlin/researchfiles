...
module Hybrid_128_BK6_SA1_top (a,b,cin,sum,cout,clk,rst);
input [63:0]a;
input [63:0]b;
input cin;
output reg [63:0]sum;
...
wire cout_w;
reg cin_r;
Hybrid_128_BK6_SA1 u0 (a,b,cin_r,sum_w,cout_w);
...
module Hybrid_128_BK6_SA1 (a,b,cin,sum,cout);
...
wire [127:0] pp_level7;
            ...
            endgenerate 
        generate
             for (i = 127;i<128 ;i=i+128) begin
             assign gnpg_level7[i+0]=gnpg_level6[i+0]|pp_level6[i+0]&gnpg_level6[i-64];  
             assign pp_level7[i+0]=pp_level6[i+0]&pp_level6[i-64];            
         end
       endgenerate
       //old_value_pass
       generate
             for (i = 191;i<128 ;i=i+128) begin
