...
module Hybrid_128_BK3_KL4_Fanout8_top (a,b,cin,sum,cout,clk,rst);
input [127:0]a;
input [127:0]b;
input cin;
...
wire cout_w;
reg cin_r;
Hybrid_128_BK3_KL4_Fanout8 u0 (a,b,cin_r,sum_w,cout_w);
...
module Hybrid_128_BK3_KL4_Fanout8 (a,b,cin,sum,cout);
...
wire [127:0] pp_level7;
         ...
         // strange part
          ...
          // pre process continue last 1
           generate
            for (i = 32;i<8*8 ;i=i+8) begin
              assign  gnpg_level6[7+i]=gnpg_level5[7+i]|pp_level5[7+i]&gnpg_level5[i+7-32]; 
              assign  pp_level6[7+i]=pp_level5[7+i]&pp_level5[i+7-32];
            end
           endgenerate
          ...
          // pre process continue last 1
           generate
            for (i = 32;i<8*8 ;i=i+8) begin
              assign  gnpg_level6[71+i]=gnpg_level5[71+i]|pp_level5[71+i]&gnpg_level5[i+71-32]; 
              assign  pp_level6[71+i]=pp_level5[71+i]&pp_level5[i+71-32];
            end
           endgenerate
         ...
         // strange part
            ...
            for (i = 0;i<32 ;i=i+8 ) begin
              assign  gnpg_level6[71+i]=gnpg_level5[71+i]; 
              assign  pp_level6[71+i]=pp_level5[71+i];
            end 
            endgenerate
          // before start point
            generate
         ...
         generate
           for (i = 71;i<8*8+71 ;i=i+8) begin
              assign  gnpg_level7[i]=gnpg_level6[i]|pp_level6[i]&gnpg_level6[71+8*8-8-8*8];
              assign  pp_level7[i]=pp_level6[i]&pp_level6[71+8*8-8-8*8];
           end 
         endgenerate
