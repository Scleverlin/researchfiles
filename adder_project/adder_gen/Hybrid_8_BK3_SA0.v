...
module Hybrid_8_BK3_SA0_top (a,b,cin,sum,cout,clk,rst);
input [7:0]a;
input [7:0]b;
input cin;
output reg [7:0]sum;
...
wire cout_w;
reg cin_r;
Hybrid_8_BK3_SA0 u0 (a,b,cin_r,sum_w,cout_w);
...
module Hybrid_8_BK3_SA0 (a,b,cin,sum,cout);
