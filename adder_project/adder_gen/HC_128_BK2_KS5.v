...
module HC_128_BK2_KS5_top (a,b,cin,sum,cout,clk,rst);
input [127:0]a;
input [127:0]b;
input cin;
...
wire cout_w;
reg cin_r;
HC_128_BK2_KS5 u0 (a,b,cin_r,sum_w,cout_w);
...
module HC_128_BK2_KS5 (a,b,cin,sum,cout);
...
wire [127:0] pp_level7;
        ...
        generate
            ...
            //KS 
            generate
              for (i = 0;i<(128-67) ;i=i+4) begin
                assign gnpg_level7[67+i]=gnpg_level6[67+i]|pp_level6[67+i]&gnpg_level6[67+i-16*4];
                assign pp_level7[67+i]=pp_level6[67+i]&pp_level6[67+i-16*4];
               end
            endgenerate
            generate
