...
module Hybrid_128_BK1_KL6_Fanout16_top (a,b,cin,sum,cout,clk,rst);
input [63:0]a;
input [63:0]b;
input cin;
output reg [63:0]sum;
...
wire cout_w;
reg cin_r;
Hybrid_128_BK1_KL6_Fanout16 u0 (a,b,cin_r,sum_w,cout_w);
...
module Hybrid_128_BK1_KL6_Fanout16 (a,b,cin,sum,cout);
...
wire [127:0] pp_level7;
         ...
         // strange part
          ...
          // pre process continue last 1
           generate
            for (i = 16;i<2*16 ;i=i+2) begin
              assign  gnpg_level5[65+i]=gnpg_level4[65+i]|pp_level4[65+i]&gnpg_level4[i+65-16]; 
              assign  pp_level5[65+i]=pp_level4[65+i]&pp_level4[i+65-16];
            end
           endgenerate
          ...
          // pre process continue last 1
           generate
            for (i = 16;i<2*16 ;i=i+2) begin
              assign  gnpg_level5[97+i]=gnpg_level4[97+i]|pp_level4[97+i]&gnpg_level4[i+97-16]; 
              assign  pp_level5[97+i]=pp_level4[97+i]&pp_level4[i+97-16];
            end
           endgenerate
         ...
         // strange part
            generate
            for (i = 0;i<16 ;i=i+2 ) begin
              assign  gnpg_level5[65+i]=gnpg_level4[65+i]; 
              assign  pp_level5[65+i]=pp_level4[65+i];
            end 
            endgenerate
         // strange part
            generate
            for (i = 0;i<16 ;i=i+2 ) begin
              assign  gnpg_level5[97+i]=gnpg_level4[97+i]; 
              assign  pp_level5[97+i]=pp_level4[97+i];
            end 
            endgenerate
          // before start point
            generate
         ...
         generate
           for (i = 33;i<2*16+33 ;i=i+2) begin
         ...
         // Multiple fanout stage
         generate
           for (i = 65;i<2*16+65 ;i=i+2) begin
              assign  gnpg_level6[i]=gnpg_level5[i]|pp_level5[i]&gnpg_level5[65+2*16-2-2*16];
              assign  pp_level6[i]=pp_level5[i]&pp_level5[65+2*16-2-2*16];
           end 
         endgenerate
         
         // Multiple fanout stage
         generate
           for (i = 97;i<2*16+97 ;i=i+2) begin
              assign  gnpg_level6[i]=gnpg_level5[i]|pp_level5[i]&gnpg_level5[97+2*16-2-2*16];
              assign  pp_level6[i]=pp_level5[i]&pp_level5[97+2*16-2-2*16];
           end 
         endgenerate
         ...
         generate
           for (i = 65;i<2*16+65 ;i=i+2) begin
              assign  gnpg_level7[i]=gnpg_level6[i]|pp_level6[i]&gnpg_level6[65+2*16-2-2*32];
              assign  pp_level7[i]=pp_level6[i]&pp_level6[65+2*16-2-2*32];
           end 
         endgenerate
         ...
         generate
           for (i = 97;i<2*16+97 ;i=i+2) begin
              assign  gnpg_level7[i]=gnpg_level6[i]|pp_level6[i]&gnpg_level6[97+2*16-2-2*32];
              assign  pp_level7[i]=pp_level6[i]&pp_level6[97+2*16-2-2*32];
           end 
         endgenerate
