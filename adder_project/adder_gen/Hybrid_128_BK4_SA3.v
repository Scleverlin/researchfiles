...
module Hybrid_128_BK4_SA3_top (a,b,cin,sum,cout,clk,rst);
input [63:0]a;
input [63:0]b;
input cin;
output reg [63:0]sum;
...
wire cout_w;
reg cin_r;
Hybrid_128_BK4_SA3 u0 (a,b,cin_r,sum_w,cout_w);
...
module Hybrid_128_BK4_SA3 (a,b,cin,sum,cout);
...
wire [127:0] pp_level7;
       ...
       endgenerate 
        generate
             for (i = 79;i<128 ;i=i+128) begin
             assign gnpg_level7[i+0]=gnpg_level6[i+0]|pp_level6[i+0]&gnpg_level6[i-16];  
             assign pp_level7[i+0]=pp_level6[i+0]&pp_level6[i-16];            
         end
       endgenerate
       //old_value_pass
       generate
             for (i = 143;i<128 ;i=i+128) begin
       ...
       endgenerate
        ...
        generate
             for (i = 79;i<128 ;i=i+128) begin
             assign gnpg_level7[i+16]=gnpg_level6[i+16]|pp_level6[i+16]&gnpg_level6[i-16];  
             assign pp_level7[i+16]=pp_level6[i+16]&pp_level6[i-16];            
         end
       endgenerate
       //old_value_pass
       generate
       ...
       endgenerate
        ...
        generate
             for (i = 79;i<128 ;i=i+128) begin
             assign gnpg_level7[i+32]=gnpg_level6[i+32]|pp_level6[i+32]&gnpg_level6[i-16];  
             assign pp_level7[i+32]=pp_level6[i+32]&pp_level6[i-16];            
         end
       endgenerate
       //old_value_pass
       generate
       ...
       endgenerate
        ...
        generate
             for (i = 79;i<128 ;i=i+128) begin
             assign gnpg_level7[i+48]=gnpg_level6[i+48]|pp_level6[i+48]&gnpg_level6[i-16];  
             assign pp_level7[i+48]=pp_level6[i+48]&pp_level6[i-16];            
         end
       endgenerate
       //old_value_pass
       generate
