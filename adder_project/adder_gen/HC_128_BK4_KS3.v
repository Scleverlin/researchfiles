...
module HC_128_BK4_KS3 (a,b,cin,sum,cout);
...
wire [127:0] pp_level7;
        ...
        generate
            ...
            //KS 
            generate
              for (i = 0;i<(128-79) ;i=i+16) begin
                assign gnpg_level7[79+i]=gnpg_level6[79+i]|pp_level6[79+i]&gnpg_level6[79+i-4*16];
                assign pp_level7[79+i]=pp_level6[79+i]&pp_level6[79+i-4*16];
               end
            endgenerate
            generate
