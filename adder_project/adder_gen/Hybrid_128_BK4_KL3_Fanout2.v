...
module Hybrid_128_BK4_KL3_Fanout2_top (a,b,cin,sum,cout,clk,rst);
input [127:0]a;
input [127:0]b;
input cin;
...
wire cout_w;
reg cin_r;
Hybrid_128_BK4_KL3_Fanout2 u0 (a,b,cin_r,sum_w,cout_w);
...
module Hybrid_128_BK4_KL3_Fanout2 (a,b,cin,sum,cout);
...
wire [127:0] pp_level7;
          ...
          // pre process continue last 1
           generate
            for (i = 16;i<16*2 ;i=i+16) begin
              assign  gnpg_level5[111+i]=gnpg_level4[111+i]|pp_level4[111+i]&gnpg_level4[i+111-16]; 
              assign  pp_level5[111+i]=pp_level4[111+i]&pp_level4[i+111-16];
            end
           endgenerate
         ...
         // strange part
            generate
            for (i = 0;i<16 ;i=i+16 ) begin
              assign  gnpg_level5[111+i]=gnpg_level4[111+i]; 
              assign  pp_level5[111+i]=pp_level4[111+i];
            end 
            endgenerate
          // before start point
            generate
         ...
         generate
           for (i = 47;i<16*2+47 ;i=i+16) begin
         ...
         // Multiple fanout stage
         generate
           for (i = 79;i<16*2+79 ;i=i+16) begin
              assign  gnpg_level6[i]=gnpg_level5[i]|pp_level5[i]&gnpg_level5[79+16*2-16-16*2];
              assign  pp_level6[i]=pp_level5[i]&pp_level5[79+16*2-16-16*2];
           end 
         endgenerate
         
         // Multiple fanout stage
         generate
           for (i = 111;i<16*2+111 ;i=i+16) begin
              assign  gnpg_level6[i]=gnpg_level5[i]|pp_level5[i]&gnpg_level5[111+16*2-16-16*2];
              assign  pp_level6[i]=pp_level5[i]&pp_level5[111+16*2-16-16*2];
           end 
         endgenerate
         ...
         generate
           for (i = 79;i<16*2+79 ;i=i+16) begin
              assign  gnpg_level7[i]=gnpg_level6[i]|pp_level6[i]&gnpg_level6[79+16*2-16-16*4];
              assign  pp_level7[i]=pp_level6[i]&pp_level6[79+16*2-16-16*4];
           end 
         endgenerate
         ...
         generate
           for (i = 111;i<16*2+111 ;i=i+16) begin
              assign  gnpg_level7[i]=gnpg_level6[i]|pp_level6[i]&gnpg_level6[111+16*2-16-16*4];
              assign  pp_level7[i]=pp_level6[i]&pp_level6[111+16*2-16-16*4];
           end 
         endgenerate
