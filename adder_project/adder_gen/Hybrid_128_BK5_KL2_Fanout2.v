...
module Hybrid_128_BK5_KL2_Fanout2_top (a,b,cin,sum,cout,clk,rst);
input [127:0]a;
input [127:0]b;
input cin;
...
wire cout_w;
reg cin_r;
Hybrid_128_BK5_KL2_Fanout2 u0 (a,b,cin_r,sum_w,cout_w);
...
module Hybrid_128_BK5_KL2_Fanout2 (a,b,cin,sum,cout);
...
wire [127:0] pp_level7;
          ...
          // pre process continue last 1
           generate
            for (i = 32;i<32*2 ;i=i+32) begin
              assign  gnpg_level6[31+i]=gnpg_level5[31+i]|pp_level5[31+i]&gnpg_level5[i+31-32]; 
              assign  pp_level6[31+i]=pp_level5[31+i]&pp_level5[i+31-32];
            end
           endgenerate
          ...
          // pre process continue last 1
           generate
            for (i = 32;i<32*2 ;i=i+32) begin
              assign  gnpg_level6[95+i]=gnpg_level5[95+i]|pp_level5[95+i]&gnpg_level5[i+95-32]; 
              assign  pp_level6[95+i]=pp_level5[95+i]&pp_level5[i+95-32];
            end
           endgenerate
         ...
         // strange part
            ...
            for (i = 0;i<32 ;i=i+32 ) begin
              assign  gnpg_level6[95+i]=gnpg_level5[95+i]; 
              assign  pp_level6[95+i]=pp_level5[95+i];
            end 
            endgenerate
          // before start point
            generate
          ...
          // space between point and next point
            generate
            for (i = 63+1;i<63+32;i=i+1 ) begin
              assign  gnpg_level6[i]=gnpg_level5[i]; 
              assign  pp_level6[i]=pp_level5[i];
            end 
            endgenerate  
          ...
          // space between point and next point
            generate
            for (i = 95+1;i<95+32;i=i+1 ) begin
              assign  gnpg_level6[i]=gnpg_level5[i]; 
              assign  pp_level6[i]=pp_level5[i];
            end 
            endgenerate  
         ...
         generate
           for (i = 95;i<32*2+95 ;i=i+32) begin
              assign  gnpg_level7[i]=gnpg_level6[i]|pp_level6[i]&gnpg_level6[95+32*2-32-32*2];
              assign  pp_level7[i]=pp_level6[i]&pp_level6[95+32*2-32-32*2];
           end 
         endgenerate
    ...
    wire [127:0] gnpg_level12;  
    
    wire [62-1:0] gnpg_level11;   
    wire [62-1:0] pp_level11; 
...
assign sum[128:1]=p[128:1]^gnpg_level12[128-1:0];
assign cout =g[128]|p[128]&gnpg_level12[128-1];
assign gnpg_level12[0]=gnpg_level7[0];
assign gnpg_level12[1]=gnpg_level7[1];
assign gnpg_level12[2]=gnpg_level7[2]|pp_level7[2]&gnpg_level7[1];
assign gnpg_level12[127]=gnpg_level7[127];
generate 
   for (i = 1;i<(128-2)/2 ;i=i+1 ) begin
      assign gnpg_level12[2*i+1]=gnpg_level11[i-1];
   end
endgenerate
generate 
   for (i = 2;i<128/2 ;i=i+1 ) begin
      assign gnpg_level12[2*i]=gnpg_level7[2*i]|pp_level7[2*i]&gnpg_level11[i-2];
   end
endgenerate


assign gnpg_level11[0]=gnpg_level7[3];
assign gnpg_level11[1]=gnpg_level7[2+3]|pp_level7[2+3]&gnpg_level7[2+3-2];
generate 

   for (i = 3;i<62;i=i+2 ) begin
      assign gnpg_level11[i]=gnpg_level7[2*i+3]|pp_level7[2*i+3]&gnpg_level10[(i-3)/2];
   end
endgenerate
generate 
...
assign gnpg_level10[0]=gnpg_level7[7];
assign gnpg_level10[1]=gnpg_level7[4+7]|pp_level7[4+7]&gnpg_level7[4+7-4];
generate 

   for (i = 3;i<30;i=i+2 ) begin
      assign gnpg_level10[i]=gnpg_level7[4*i+7]|pp_level7[4*i+7]&gnpg_level9[(i-3)/2];
   end
endgenerate
generate 
...
assign gnpg_level9[0]=gnpg_level7[15];
assign gnpg_level9[1]=gnpg_level7[8+15]|pp_level7[8+15]&gnpg_level7[8+15-8];
generate 

   for (i = 3;i<14;i=i+2 ) begin
      assign gnpg_level9[i]=gnpg_level7[8*i+15]|pp_level7[8*i+15]&gnpg_level8[(i-3)/2];
   end
endgenerate
generate 
...
//1111
assign gnpg_level8[0]=gnpg_level7[31];
assign gnpg_level8[1]=gnpg_level7[16+31]|pp_level7[16+31]&gnpg_level7[16+31-16];
generate 
//1111
   for (i = 3;i<6;i=i+2 ) begin
      assign gnpg_level8[i]=gnpg_level7[16*i+31]|pp_level7[16*i+31]&gnpg_level7[16*i+31-16];
   end
endgenerate
generate 
//1111
   for (i = 2;i<6 ;i=i+2 ) begin
      assign gnpg_level8[i]=gnpg_level7[16*i+31];
   end
endgenerate
