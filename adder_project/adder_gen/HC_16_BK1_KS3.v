...
module HC_16_BK1_KS3_top (a,b,cin,sum,cout,clk,rst);
input [15:0]a;
input [15:0]b;
input cin;
output reg [15:0]sum;
...
wire cout_w;
reg cin_r;
HC_16_BK1_KS3 u0 (a,b,cin_r,sum_w,cout_w);
...
module HC_16_BK1_KS3 (a,b,cin,sum,cout);
