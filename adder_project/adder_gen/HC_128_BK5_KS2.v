...
module HC_128_BK5_KS2_top (a,b,cin,sum,cout,clk,rst);
input [63:0]a;
input [63:0]b;
input cin;
output reg [63:0]sum;
...
wire cout_w;
reg cin_r;
HC_128_BK5_KS2 u0 (a,b,cin_r,sum_w,cout_w);
...
module HC_128_BK5_KS2 (a,b,cin,sum,cout);
...
wire [127:0] pp_level7;
        ...
        generate
            ...
            //KS 
            generate
              for (i = 0;i<(128-95) ;i=i+32) begin
                assign gnpg_level7[95+i]=gnpg_level6[95+i]|pp_level6[95+i]&gnpg_level6[95+i-2*32];
                assign pp_level7[95+i]=pp_level6[95+i]&pp_level6[95+i-2*32];
               end
            endgenerate
            generate
