...
module HC_128_BK6_KS1_top (a,b,cin,sum,cout,clk,rst);
input [63:0]a;
input [63:0]b;
input cin;
output reg [63:0]sum;
...
wire cout_w;
reg cin_r;
HC_128_BK6_KS1 u0 (a,b,cin_r,sum_w,cout_w);
...
module HC_128_BK6_KS1 (a,b,cin,sum,cout);
...
wire [127:0] pp_level7;
            ...
            //KS 
            generate
              for (i = 0;i<(128-127) ;i=i+64) begin
                assign gnpg_level7[127+i]=gnpg_level6[127+i]|pp_level6[127+i]&gnpg_level6[127+i-1*64];
                assign pp_level7[127+i]=pp_level6[127+i]&pp_level6[127+i-1*64];
               end
            endgenerate
            generate
