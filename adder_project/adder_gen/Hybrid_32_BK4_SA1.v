...
module Hybrid_32_BK4_SA1_top (a,b,cin,sum,cout,clk,rst);
input [31:0]a;
input [31:0]b;
input cin;
output reg [31:0]sum;
...
wire cout_w;
reg cin_r;
Hybrid_32_BK4_SA1 u0 (a,b,cin_r,sum_w,cout_w);
...
module Hybrid_32_BK4_SA1 (a,b,cin,sum,cout);
