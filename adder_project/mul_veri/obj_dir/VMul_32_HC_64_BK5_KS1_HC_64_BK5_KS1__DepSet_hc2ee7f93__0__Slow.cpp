...
VL_ATTR_COLD void VMul_32_HC_64_BK5_KS1_HC_64_BK5_KS1___ctor_var_reset(VMul_32_HC_64_BK5_KS1_HC_64_BK5_KS1* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    VMul_32_HC_64_BK5_KS1__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+        VMul_32_HC_64_BK5_KS1_HC_64_BK5_KS1___ctor_var_reset\n"); );
    // Body
