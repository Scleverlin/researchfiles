...
VL_ATTR_COLD void VMul_32_Hybrid_64_BK0_KL6_Fanout16___024root___ctor_var_reset(VMul_32_Hybrid_64_BK0_KL6_Fanout16___024root* vlSelf) {
    ...
    // Body
    vlSelf->Hybrid_64_BK0_KL6_Fanout16_top__02Ea = VL_RAND_RESET_Q(64);
    vlSelf->Hybrid_64_BK0_KL6_Fanout16_top__02Eb = VL_RAND_RESET_Q(64);
    vlSelf->cin = VL_RAND_RESET_I(1);
    vlSelf->sum = VL_RAND_RESET_Q(64);
    vlSelf->cout = VL_RAND_RESET_I(1);
    vlSelf->clk = VL_RAND_RESET_I(1);
    vlSelf->rst = VL_RAND_RESET_I(1);
    vlSelf->Mul_32_Hybrid_64_BK0_KL6_Fanout16__02Ea = VL_RAND_RESET_I(32);
    vlSelf->Mul_32_Hybrid_64_BK0_KL6_Fanout16__02Eb = VL_RAND_RESET_I(32);
