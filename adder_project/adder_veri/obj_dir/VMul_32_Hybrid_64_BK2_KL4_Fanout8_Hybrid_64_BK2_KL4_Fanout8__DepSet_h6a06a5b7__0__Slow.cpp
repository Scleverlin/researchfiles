...
VL_ATTR_COLD void VMul_32_Hybrid_64_BK2_KL4_Fanout8_Hybrid_64_BK2_KL4_Fanout8___ctor_var_reset(VMul_32_Hybrid_64_BK2_KL4_Fanout8_Hybrid_64_BK2_KL4_Fanout8* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    VMul_32_Hybrid_64_BK2_KL4_Fanout8__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+        VMul_32_Hybrid_64_BK2_KL4_Fanout8_Hybrid_64_BK2_KL4_Fanout8___ctor_var_reset\n"); );
    // Body
