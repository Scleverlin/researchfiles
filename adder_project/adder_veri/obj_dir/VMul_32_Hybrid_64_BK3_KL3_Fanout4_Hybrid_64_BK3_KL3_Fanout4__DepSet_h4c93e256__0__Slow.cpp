...
VL_ATTR_COLD void VMul_32_Hybrid_64_BK3_KL3_Fanout4_Hybrid_64_BK3_KL3_Fanout4___ctor_var_reset(VMul_32_Hybrid_64_BK3_KL3_Fanout4_Hybrid_64_BK3_KL3_Fanout4* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    VMul_32_Hybrid_64_BK3_KL3_Fanout4__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+        VMul_32_Hybrid_64_BK3_KL3_Fanout4_Hybrid_64_BK3_KL3_Fanout4___ctor_var_reset\n"); );
    // Body
